...
//        view.backgroundColor = UIColor.systemGray5
        ...
        navigationItem.title = "Beyond Identity CIAM Demos"
        ...
        let embeddedButton = makeButton(with: "Embedded SDK Demo")
        embeddedButton.addTarget(self, action: #selector(toEmbedded), for: .touchUpInside)
        
        let embeddedUIButton = makeButton(with: "Embedded UI SDK Demo")
